...
| theme-repository           | String   |      No      | Repository that contains customized themes. You have to put it in this way: <owner>/<repository> (e.g., Pearson-Advance/openedx-themes)                                                                                                                                                                                                                                                                                                                          |
