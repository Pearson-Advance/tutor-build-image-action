...
| plugins   | String     | JSON array string containing the information of the plugins desired to install. Example: '[{"plugin_name":"ecommerce","package_name":"tutor-ecommerce==15"},{"plugin_name":"discovery","package_name":"tutor-discovery==15"},{"plugin_name":"mfe","package_name":"tutor-mfe==15"}]'              |
